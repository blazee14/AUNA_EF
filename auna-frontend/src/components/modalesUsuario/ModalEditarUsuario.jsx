...
export const ModalEditarUsuario = ({ show, onClose, onUpdate, usuarioActual }) => {
    ...
    return (
        <div className="modal-overlay" role="dialog" aria-modal="true" aria-labelledby="modal-editar-usuario-title">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 id="modal-editar-usuario-title" className="modal-title">Editar Usuario</h5>
                        <button
                            type="button"
